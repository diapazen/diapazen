 ...
 * PollModel
 *
 * Classe gérant les sondages dans la base de données
 * 
 * @package     Diapazen
 * @subpackage  Model
 */
class PollModel extends Model
{
	 ...
	 * clôture le sondage en mettant à 0 dans la colonne open de la table du sondage.
	 * @param string $pollId valeur à insérer
